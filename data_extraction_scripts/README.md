...
This repository contains the Sparrow Invoice Dataset with 500 annotated invoice documents ready for OCR and document understanding tasks.
...
### Extract All Data (Recommended First Step)

Run this script to extract all images and JSON annotations into organized folders:
...
After extraction, you can easily work with images and JSON files:
...
- **Comment non-obvious code**: Added inline comments explaining complex logic
- **Longer names for clarity**: Used descriptive variable and function names
- **Ask questions if uncertain**: Verified file paths and data structure before implementation
- **Reuse existing code**: Built upon standard pandas/PIL libraries
